#ifndef _OptionsParser_H
#define _OptionsParser_H
...
public:
	OptionsParser();
	OptionsParser(int maxoptions );
	OptionsParser(int maxoptions , int maxcharoptions);
	~OptionsParser();

     // following set methods specifies the  
	 // special characters and delimiters 
	 // if not set traditional defaults will be used
	 // see optionsparser.cpp for ccomplete documentation
